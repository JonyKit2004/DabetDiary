...
import dem.corp.diabetdiary.databinding.ActivityDoctorregisterBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.signUpBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String workplace = binding.workplaceEt.getText().toString().trim();
                ...
                binding.workplaceErrorTv.setVisibility(View.GONE);
                ...
                if (password.isEmpty()) {
                    ...
                    binding.passwordErrorTv.setText("Пароль должен содержать минимум 8 символов, 1 цифру и 1 букву");
                    binding.passwordErrorTv.setVisibility(View.VISIBLE);
                    binding.passwordErrorTv.setBackgroundColor(Color.parseColor("#E0FFE0"));
                    valid = false;
                }
                ...
                if (workplace.isEmpty()) {
                    binding.workplaceErrorTv.setTextColor(Color.RED);
                    binding.workplaceErrorTv.setText("Поля не могут быть пустыми");
                    binding.workplaceErrorTv.setVisibility(View.VISIBLE);
                    binding.workplaceErrorTv.setBackgroundColor(Color.parseColor("#E0FFE0"));
                    valid = false;
                }

                if (valid) {
                    showUserAgreementDialog(email, password, username, userid, workplace);
                }
            }

            private void showUserAgreementDialog(String email, String password, String username, String userid, String workplace) {
                                                ...
                                                databaseReference.setValue(userInfo).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        if (task.isSuccessful()) {
                                                            ...
                                                            Toast.makeText(getApplicationContext(), "Не удалось сохранить информацию о докторе", Toast.LENGTH_SHORT).show();
                                                        }
                                                    }
                                                });
                                            } else {
